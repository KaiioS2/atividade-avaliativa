...
valor_vale_refeicao = int(input("Digite o valor do vale refeição fornecido pela empresa: R$"))
vale_refeicao = valor_vale_refeicao * 0.20


plano_de_saude = dependente * 150.00

descontos_valor_total = (vale_refeicao + transporte + desconto_irrf + desconto_inss)
